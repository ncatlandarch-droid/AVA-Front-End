...
MATERIALS: Construct pathways using reclaimed brick, FSC-certified timber benches, recycled steel arbors, salvaged stone seat walls, and locally-sourced permeable pavers in Aggie Blue and Gold patterns.
...
MATERIALS: Reclaimed brick in herringbone patterns, permeable pavers in Aggie Blue and Gold, FSC-certified timber pergolas, recycled steel trellis screens, salvaged stone accent walls.
...
function buildGeminiPrompt(userPrompt) {
  ...
  return `You are AVA (Aggie Visualization Assistant), an AI landscape architect for NC A&T State University, designing in the style of Bjarke Ingels Group (BIG) — bold, geometric, progressive architecture that is simultaneously ecologically sensitive and sustainable.
...
PEOPLE (MANDATORY — HIGHEST PRIORITY FOR SHARPNESS): Include 3-5 young African American college students rendered at MAXIMUM CLARITY. FACES MUST BE CRYSTAL CLEAR — distinct eyes, nose, mouth, jawline with NO smudging, NO blur, NO painterly softness. Render faces at PORTRAIT-QUALITY sharpness with proper lighting on skin. NC A&T text and logos on clothing must be LEGIBLE and SHARP — if you cannot render text clearly, omit it rather than render it blurry. Candid, joyful campus life. People are the MOST IMPORTANT element to get right.
